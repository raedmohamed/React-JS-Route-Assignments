...
var typed = new Typed('.type', {
  ...
  typeSpeed: 50, // Increased typing speed for smoother effect
  backSpeed: 30, // Adjusted backspacing speed to be slightly slower
  loop: true,
  startDelay: 200, // Shortened start delay for faster cycle start
  backDelay: 1500, // Increased back delay for smoother pause after typing
  smartBackspace: false, // Only backspaces to the first different character
});
